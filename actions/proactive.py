...
class ProactiveEngine:
    ...
    def build_prompt(
        ...
        return "\n".join([
            ...
            "- 1-2 sentences max. Natural, warm, never robotic, and always formally respectful.",
            "- Use formal pronouns and honorifics in the selected language; never use slang or buddy language.",
